        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto; background-color: #ffffff;" class="email-container">
          ...
          <tr style="background-color: #FFFFFF;">
              <td style="padding: 40px; padding-bottom: 0;">
                  ...
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 17px; line-height: 27px; color: #575756; text-align: left; font-weight: 400;">
                      Nombre: {{ $user->name }}
                  </p>
          ...
          <tr style="background-color: #FFFFFF;">
              <td style="background-color: #FFFFFF; padding: 20px 30px;">
                  ...
                  <h2 class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; color: #575756; text-align: left; font-weight: 400;">
                      FECHA: {{ date("F j, Y") }}
                  </h2>
                  ...
                  <table cellspacing="0" cellpadding="0" border="0" width="100%" align="center">
                      ...
                      @foreach($products as $key => $product)
                        ...
                        <tr style="border-bottom: solid grey 1px;">
                          <td class="fallback-font" style="padding: 10px; text-align: left; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 24px; font-weight: 400;">{{ $product['name'] }}</td>
                          <td class="fallback-font" style="padding: 10px; text-align: center; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 24px; font-weight: 400;">{{ $product['quantity'] }}</td>
                          <td class="fallback-font" style="padding: 10px; text-align: right; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 24px; font-weight: 400;">{{ $product['price'] }}</td>
                        </tr>

                      @endforeach

                      <tr>
                          <td colspan="2" class="fallback-font" style="padding: 10px; text-align: left; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 24px; font-weight: 700;">PUNTOS CANJEADOS:</td>
                          <td class="fallback-font" style="padding: 10px; text-align: right; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 24px; font-weight: 400;">
                            {{ number_format($exchange->points_quantity, 0, ',', '.') }}
                          </td>
                      </tr>
          ...
          <tr style="background-color: #000000;">
              <td style="background-color: #000000; text-align: center; padding: 40px;">
                ...
                <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #FFFFFF; text-align: center; font-weight: 400;">
                  <strong>Ingresá a la plataforma Monster Miles</strong>
                </p>
                  <!-- Button : BEGIN -->
