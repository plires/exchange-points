          ...
          <tr style="background-color: #85bf00;">
              <td style="padding: 10px; vertical-align: middle;">
                  ...
                  <h1 class="fallback-font" style="margin: 0px!important; font-family: 'Montserrat', sans-serif; font-size: 18px; color: #FFFFFF; text-align: center; font-weight: 700;">
                      <strong>REGISTRO PENDIENTE DE ACEPTACIÓN</strong>
                  </h1>
          ...
          <tr style="background-color: #FFFFFF;">
              <td style="padding: 40px; padding-bottom: 0;">
                  ...
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: center; font-weight: 400;">
                      Muchas gracias por registrarte en la plataforma Monster Miles. Tu proceso de registro ya esta en curso. Recibirás una notificación cuando el administrador verifique y apruebe tu solicitud.
                  </p>

                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: center; font-weight: 400;">
                      Si tenes alguna duda sobre esta operación podes contactarnos a <a style="color: #85bf00;" href="mailto:info@monsterenergymiles.com">info@monsterenergymiles.com</a>
                  </p>
