        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto; background-color: #ffffff;" class="email-container">
          ...
          <tr style="background-color: #FFFFFF;">
              <td style="padding: 40px; padding-bottom: 0;">
                  ...
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: center; font-weight: 400;">
                      Podés restablecer tu contraseña haciendo click en el siguiente botón.
                  </p>
          ...
          <!-- Boton : BEGIN -->
          <tr style="background-color: #FFFFFF;">
              <td style="background-color: #FFFFFF; text-align: center; padding: 40px; padding-bottom: 0;">

                <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #000000; text-align: center; font-weight: 400;">
          ...
          <tr style="background-color: #FFFFFF;">
              <td style="padding: 40px;">
                  ...
                  <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; line-height: 26px; color: #575756; text-align: center; font-weight: 400;">
                      <strong>Monster Miles</strong> te saluda!
                  </p>

                  <hr>

                  <span class="fallback-font break-all" style="box-sizing: border-box; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 24px; color: #575756; text-align: center; font-weight: 400; position: relative; word-break: break-all;">
                    Si tenes problemas para hacer clic en el botón "Restablecer", copia y pega la siguiente URL en tu navegador web: 
