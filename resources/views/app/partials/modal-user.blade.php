    ...
    <div class="modal-content">
      ...
      <form id="userForm" class="needs-validation" novalidate>
        ...
        <div class="modal-footer justify-content-between">
          <button type="button" class="btn btn-secondary transition" data-dismiss="modal">Cerrar</button>
          <button type="button" type="submit" @click.prevent="sendUser" name="send" class="btn btn-primary transition">Guardar cambios</button>
        </div>
      </form>
