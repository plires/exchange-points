    ...
    <div class="modal-content">
      ...
      <form id="userForm" class="needs-validation" novalidate>
          ...
          <div class="card">
            ...
            <!-- form start -->
              <div class="card-body">
                ...
                <div v-if="modePasswordEdit" class="form-group col-md-6">
        ...
        <div class="modal-footer justify-content-between">
          ...
          <button v-if="!modePasswordEdit" type="button" type="submit" @click.prevent="sendUser" name="send" class="btn btn-primary">Agregar</button>
