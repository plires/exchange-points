...
@section('content')
<div class="container">
    <div style="display: flex; height: 100vh; align-items: center;" class="row justify-content-center align-center">
        <div class="col-md-8">
            <div class="card">
                <div style="background-color: var(--primary-color); color: white;" class="card-header">{{ __('Verifique su dirección de correo electrónico') }}</div>
