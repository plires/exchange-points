...
class CreateProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'availability'      => ['required', 'numeric', 'min:0', 'max:999999'],
    ...
    function messages()
    {
        return [
            ...
            'price.max'             => 'El valor del precio no puede ser mayor o igual a 999.999',
            'availability.required' => 'Ingresá el stock', 
            'availability.numeric'  => 'El valor del stock debe ser un entero', 
            'availability.min'      => 'El valor del stock no puede ser menor o igual a 0', 
            'availability.max'      => 'El valor del stock no puede ser menor o igual a 999999', 
